...
<div class="welcomeMessage">
	Пожалуйста, напишите ниже свою последовательность из случайных цифр от 0 до 9, не короче 300 символов, и получите оценку того, насколько она случайна. Если вы не понимаете, что происходит и зачем это все нужно, посетите раздел W.T.F. <br>
	Узнать средний результат всех пользователей можно в разделе "СТАТИСТИКА"
</div>
